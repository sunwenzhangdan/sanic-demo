...
class OutboundStatistics(Model):
    id = fields.IntField(pk=True)
    sap_no = fields.BigIntField(pk=False)
    out_type = fields.CharField(100)
    out_category = fields.CharField(100)
    deliver_year = fields.BigIntField(pk=False)
    ...
    invoice_count = fields.BigIntField(pk=False)
    ...
    out_num_discount = fields.BigIntField(pk=False)